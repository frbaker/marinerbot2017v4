...
AutoDriveStraight02::AutoDriveStraight02(): Command() {
...
void AutoDriveStraight02::Initialize() {
	NoDriveIt();
}

// Called repeatedly when this Command is scheduled to run
void AutoDriveStraight02::Execute() {
	DriveIt();
}

// Make this return true when this Command no longer needs to run execute()
bool AutoDriveStraight02::IsFinished() {
