...
AutoDriveStraight2::AutoDriveStraight2(): Command() {
...
void AutoDriveStraight2::Initialize() {
	NoDriveIt();
}

// Called repeatedly when this Command is scheduled to run
void AutoDriveStraight2::Execute() {
	DriveIt();
}
