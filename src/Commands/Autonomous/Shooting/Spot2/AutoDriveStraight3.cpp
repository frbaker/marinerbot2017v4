...
AutoDriveStraight3::AutoDriveStraight3(): Command() {
...
void AutoDriveStraight3::Initialize() {
	NoDriveIt();
}

// Called repeatedly when this Command is scheduled to run
void AutoDriveStraight3::Execute() {
	DriveIt();
}
